...
{
    public class WorkshopEducationUpdateCommandValidator : AbstractValidator<WorkshopEducationUpdateCommandRequest>
    {
        public WorkshopEducationUpdateCommandValidator()
        {
