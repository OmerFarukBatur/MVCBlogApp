...
{
    public class AppointmentDetailUpdateCommandValidator : AbstractValidator<AppointmentDetailUpdateCommandRequest>
    {
        public AppointmentDetailUpdateCommandValidator()
        {
