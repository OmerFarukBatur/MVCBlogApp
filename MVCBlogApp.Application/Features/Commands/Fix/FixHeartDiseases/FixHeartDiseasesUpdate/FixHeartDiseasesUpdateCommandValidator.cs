...
{
    public class FixHeartDiseasesUpdateCommandValidator : AbstractValidator<FixHeartDiseasesUpdateCommandRequest>
    {
        public FixHeartDiseasesUpdateCommandValidator()
        {
            RuleFor(x => x.Title)
                .NotEmpty()
                .NotNull()
