...
{
    public class FixHeartDiseasesCreateCommandValidator : AbstractValidator<FixHeartDiseasesCreateCommandRequest>
    {
        public FixHeartDiseasesCreateCommandValidator()
        {
            RuleFor(x => x.Title)
                .NotEmpty()
                .NotNull()
