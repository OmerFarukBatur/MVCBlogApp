...
{
    public class VM_MemberAllDetail
    {
        ...
        public string? HowDoYouFeel { get; set; } // int to string
        public string? HowIsYourEnergy { get; set; } // int to string
        public string? HowFrequencyOfActivity { get; set; } // int to string
        public string? ConsumedVegetables { get; set; } // int to string
