...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCBlogApp.Domain.Entities.BlogCategoryRelationship", b =>
                {
                    ...
                    b.ToTable("BlogCategoryRelationships");
                });

            modelBuilder.Entity("MVCBlogApp.Domain.Entities.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("MVCBlogApp.Domain.Entities.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("MVCBlogApp.Domain.Entities.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MVCBlogApp.Domain.Entities.Identity.AppUser", null)
                        .WithMany()
